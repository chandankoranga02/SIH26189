      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filteredCases.map(cs => (
          <div
            ...
            className="intel-card p-4 space-y-3 cursor-pointer hover:border-white transition group flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-white font-bold text-sm group-hover:text-white transition">
                    {cs.name}
                  </span>
              ...
              <div className="mt-2.5 p-2 rounded bg-black border border-neutral-900 space-y-1 text-[11px] font-mono">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-neutral-400 font-bold">{(cs as any).offence || 'Transit Manifest Breach'}</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="pt-3 border-t border-neutral-900 flex items-center justify-between text-xs text-neutral-500 group-hover:text-neutral-300">
              ...
              <div className="flex items-center gap-1 text-white font-semibold text-[11px]">
